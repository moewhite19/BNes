...
public class PlayerListener implements Listener {
    ...
    @EventHandler(priority = EventPriority.HIGH)
    public void onBreakItemFram(EntityDamageByEntityEvent event) {
        if (event.getDamager() instanceof Player player && event.getEntity() instanceof ItemFrame frame && useItem(player,frame.getItem(),true,event)){
            event.setCancelled(true);
        }
    }
