...
public class MapUtils {
    public static Map<Integer, Byte> colorCacheMap = Collections.synchronizedMap(new Int2ByteOpenHashMap(64)); //缓存颜色,实际fc的颜色位数只有54,但是以防万一嘛
